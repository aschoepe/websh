...
cd src/unix
/usr/bin/autoconf
./configure --with-tclinclude=/usr/include --with-tcl=/usr/lib64 --prefix=$RPM_BUILD_ROOT/usr --with-httpdinclude=/usr/include/httpd --enable-threads --with-aprinclude=/usr/include/apr-1
make 
